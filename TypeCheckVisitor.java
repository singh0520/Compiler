...
public class TypeCheckVisitor implements ASTVisitor {
	...
	public Object visitBinaryChain(BinaryChain binaryChain, Object arg) throws Exception {
		...
		if (binaryChain.getArrow().kind.equals(ARROW)) {
			// System.out.println(binaryToken.getText());
			if (val1.equals(URL) && val2.equals(IMAGE))
				...
				else if (binaryToken.kind.equals(KW_SHOW) || binaryToken.kind.equals(KW_HIDE)
						|| binaryToken.kind.equals(KW_MOVE)) {
					binaryChain.val = FRAME;
				}

				else
					throw new TypeCheckException("Illegal Type" + binaryChain.firstToken.getText());
			}
				...
				if (binaryToken.kind.equals(OP_GRAY) || binaryToken.kind.equals(OP_BLUR)
						|| binaryToken.kind.equals(OP_CONVOLVE)) {
					binaryChain.val = IMAGE;
				}
	...
	public Object visitBinaryExpression(BinaryExpression binaryExpression, Object arg) throws Exception {
		...
		case TIMES: {
			if (val1.equals(INTEGER) && val2.equals(INTEGER))
				...
				throw new TypeCheckException("Illegal Type " + binaryExpression.firstToken.getText() + " at "
	...
	public Object visitFilterOpChain(FilterOpChain filterOpChain, Object arg) throws Exception {
		...
		if (filterOpChain.getArg().getExprList().size() == 0)
			...
			throw new TypeCheckException("Illegal Type " + filterOpChain.firstToken.getText() + " at "
					+ filterOpChain.firstToken.getLinePos());
	...
	public Object visitFrameOpChain(FrameOpChain frameOpChain, Object arg) throws Exception {
		...
		if (frameOp.equals(KW_SHOW) || frameOp.equals(KW_HIDE)) {
			if (frameOpChain.getArg().getExprList().size() == 0)
				...
				throw new TypeCheckException("Illegal Type " + frameOpChain.firstToken.getText() + " at "
						+ frameOpChain.firstToken.getLinePos());
	...
	public Object visitIdentChain(IdentChain identChain, Object arg) throws Exception {
		...
		if (ident != null) {
			identChain.setTypename(ident.getVal());
	...
	public Object visitIfStatement(IfStatement ifStatement, Object arg) throws Exception {
		if (!ifStatement.getE().visit(this, arg).equals(BOOLEAN))
			throw new TypeCheckException(
					"Illegal Type " + ifStatement.firstToken.getText() + " at " + ifStatement.firstToken.getLinePos());
	...
	public Object visitSleepStatement(SleepStatement sleepStatement, Object arg) throws Exception {
		...
		if (!sleepStatement.getE().visit(this, arg).equals(INTEGER))
			throw new TypeCheckException("Illegal Type " + sleepStatement.firstToken.getText() + " at "
					+ sleepStatement.firstToken.getLinePos());
	...
	public Object visitWhileStatement(WhileStatement whileStatement, Object arg) throws Exception {
		...
		if (!whileStatement.getE().visit(this, arg).equals(BOOLEAN))
			throw new TypeCheckException("Illegal Type " + whileStatement.firstToken.getText() + " at "
					+ whileStatement.firstToken.getLinePos());
	...
	public Object visitDec(Dec declaration, Object arg) throws Exception {
		...
		if (!check)
			throw new TypeCheckException(
					"Illegal Type " + declaration.firstToken.getText() + " at " + declaration.firstToken.getLinePos());
	...
	public Object visitAssignmentStatement(AssignmentStatement assignStatement, Object arg) throws Exception {
		if (!assignStatement.getVar().visit(this, null).equals(assignStatement.getE().visit(this, arg)))
			throw new TypeCheckException("Illegal Type " + assignStatement.firstToken.getText() + " at "
					+ assignStatement.firstToken.getLinePos());
		return null;
	}
	...
	public Object visitIdentLValue(IdentLValue identX, Object arg) throws Exception {
		...
		if (ident != null)
			...
			throw new TypeCheckException(
					"Illegal Type " + identX.firstToken.getText() + " at " + identX.firstToken.getLinePos());
	...
	public Object visitParamDec(ParamDec paramDec, Object arg) throws Exception {
		...
		if (!check)
			throw new TypeCheckException(
					"Illegal Type " + paramDec.firstToken.getText() + " at " + paramDec.firstToken.getLinePos());
		return paramDec.val;
	}
	...
	public Object visitImageOpChain(ImageOpChain imageOpChain, Object arg) throws Exception {
		...
		if (imageOp.equals(OP_WIDTH) || imageOp.equals(OP_HEIGHT)) {
			if (imageOpChain.getArg().getExprList().size() == 0)
				...
				throw new TypeCheckException("Illegal Type " + imageOpChain.firstToken.getText() + " at "
						+ imageOpChain.firstToken.getLinePos());
	...
	public Object visitTuple(Tuple tuple, Object arg) throws Exception {
		...
		for (Expression e : tuple.getExprList()) {
			if (!e.visit(this, arg).equals(INTEGER))
				throw new TypeCheckException(
						"Illegal Type " + tuple.firstToken.getText() + " at " + tuple.firstToken.getLinePos());
		}
